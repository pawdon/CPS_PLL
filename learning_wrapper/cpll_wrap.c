...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cpll

#else
#  define SWIG_init    init_cpll

#endif
#define SWIG_name    "_cpll"
...
SWIGINTERN PyObject *_wrap_test(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:test",&obj0,&obj1,&obj2)) SWIG_fail;
  {
...
SWIGINTERN PyObject *_wrap_test2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:test2",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    array1 = obj_to_array_no_conversion(obj0, NPY_DOUBLE);
    if (!array1 || !require_dimensions(array1,1) || !require_contiguous(array1)
      || !require_native(array1)) SWIG_fail;
  ...
  test2(arg1,arg2,arg3,arg4,arg5,arg6);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
